...
namespace Mordor.Process.Linq.IQToolkit.Data.Common.Expressions
{
    ...
    public class DbExpressionWriter : ExpressionWriter
    {
        ...
        private readonly Dictionary<TableAlias, int> _aliasMap = new Dictionary<TableAlias, int>();
        ...
        protected void AddAlias(TableAlias alias)
        {
            ...
            {
                _aliasMap.Add(alias, _aliasMap.Count);
            }
        }
        ...
        protected virtual Expression VisitColumn(ColumnExpression column)
        {
            int iAlias;
            var aliasName = 
                _aliasMap.TryGetValue(column.Alias, out iAlias)
                ? "A" + iAlias
